 ...
 * was specified in odp_init_global(), or if odp_init_global() has not been
 * called yet, returns the default or override log function (see
 * odp_override_log()). Always returns a valid log function, never NULL.
 *
 * @return Log function
 */
